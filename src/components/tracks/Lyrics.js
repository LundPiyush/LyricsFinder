        ...
        if (track===undefined || lyrics===undefined || Object.keys(track).length===0 || Object.keys(lyrics).length===0){
           ...
           return(
               <React.Fragment>
                ...
                <li className="list-group-item"><strong>Album ID:{track.album_id}</strong></li>
                <li className="list-group-item"><strong>Song Genre:{track.primary_genres.music_genre_list[0].music_genre.music_genre_name}</strong></li>
