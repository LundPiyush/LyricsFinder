...
const reducer=(state,action)=>{
   //step 3 => reducer fuction is called to modifiy the track_list and heading
    switch(action.type){
...
//this is Consumer part that we import in components for accessing state from context.js file